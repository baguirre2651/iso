...
export const profiler = {
    ...
    checkForIdleFrames() {
        ...
        if (idleInPastSecond >= 5) {
            ...
            debugLogger.error(`${idleInPastSecond} frames rendered while the app was ` +
    ...
    registerFlickerHandler(constrainHeight) {
        const flickerHandler = () => {
            ...
            if (!this.hasLoggedFirstFlicker) {
                ...
                debugLogger.error('A flicker frame was detected. This will cause UI instability. Type `/profile` for more info.');
            }
        };
