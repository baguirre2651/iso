...
describe('listSessions', () => {
    ...
    it('should sort sessions by start time (oldest first)', async () => {
        ...
        const sessionCalls = consoleLogSpy.mock.calls.filter((call) => typeof call[0] === 'string' &&
...
describe('deleteSession', () => {
    ...
    it('should display error for invalid session identifier (non-numeric)', async () => {
        ...
        // Assert
        expect(consoleErrorSpy).toHaveBeenCalledWith('Invalid session identifier "invalid-id". Use --list-sessions to see available sessions.');
        expect(mockDeleteSession).not.toHaveBeenCalled();
    });
    it('should display error for invalid session identifier (out of range)', async () => {
        ...
        // Assert
        expect(consoleErrorSpy).toHaveBeenCalledWith('Invalid session identifier "999". Use --list-sessions to see available sessions.');
        expect(mockDeleteSession).not.toHaveBeenCalled();
    });
    it('should display error for invalid session identifier (zero)', async () => {
        ...
        // Assert
        expect(consoleErrorSpy).toHaveBeenCalledWith('Invalid session identifier "0". Use --list-sessions to see available sessions.');
        expect(mockDeleteSession).not.toHaveBeenCalled();
    });
